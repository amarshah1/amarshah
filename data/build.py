...
if __name__ == "__main__":
    ...
    for pub in pubs_bibtex.entries.values():
        ...
        fail_if_not(
            "journal" in pub.fields or "booktitle" in pub.fields or "note" in pub.fields,
            '<p>Thank you to <a href="https://federicoaureliano.github.io/">Federico Mora</a> for the site design!</p>al" or "booktitle" field for each pub in data/publications.json!',
        )
        fail_if_not(
